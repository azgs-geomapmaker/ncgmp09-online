        ...
        for feature in gdalLayer:
            ...
            for clsField in clsFields:                                                                                          # For each field in the destination table....
                ...
                if isinstance(clsField, ForeignKey):                                                                            # If the field is a Foreign Key
                    ...
                    newFeatureArgs[clsField.name] = feature.get(gdalField)                                                      # Simply add the field value to the kwargs for the new feature
                elif clsField.name == "shape":                                                                                  # Field is the Shape / Geometry Field
